...
class NotebookPatternExtractor:
    def __init__(self, opml_path: str, notebooks_dir: str, public_api: set | None = None):
        """
    ...
    def _is_pattern_header(self, text: str) -> bool:
        ...
        return any(re.search(pattern, text.lower(), re.MULTILINE) for pattern in patterns)
    ...
    def _old_create_summary(self, patterns: Dict, summary_path: Path):
        ...
        with open(summary_path, 'w', encoding='utf-8') as f:
            ...
            f.write(
                f"> A curated collection of {len(patterns['notebooks'])} working examples "
                "demonstrating Pixeltable capabilities\n\n"
            )
