...
<Info>
  These tutorials are available as interactive Jupyter notebooks on our [Github repository](https://github.com/pixeltable/pixeltable/tree/main/docs/tutorials).
</Info>
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="calculator"
    href="/tutorials/computed-columns"
  >
  ...
  <Card
    ...
    href="/tutorials/queries-and-expressions"
  >
