...
def get_relevant_chunks(query_text: str):
    ...
    sim = chunks_view.text.similarity(string=query_text)
    return (
...
def get_relevant_transcript_chunks(query_text: str):
    ...
    sim = transcription_chunks.text.similarity(string=query_text)
    return (
...
def get_relevant_audio_chunks(query_text: str):
    ...
    sim = audio_chunks.text.similarity(string=query_text)
    return (
