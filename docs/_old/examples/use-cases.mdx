...
<Info>
All sample applications are open source and available on our [Github](https://github.com/pixeltable/pixeltable/tree/main/docs/howto/use-cases).
</Info>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="book"
    href="/howto/use-cases/rag-operations"
  >
