...
<CardGroup cols={2}>
  <Card
    ...
    icon="file-image"
    href="/notebooks/feature-guides/working-with-external-files.ipynb"
  >
  ...
  <Card
    ...
    icon="code"
    href="/notebooks/feature-guides/udfs-in-pixeltable.ipynb"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="database"
    href="/notebooks/feature-guides/embedding-indexes.ipynb"
  >
  ...
  <Card
    ...
    icon="clock"
    href="/notebooks/feature-guides/time-zones.ipynb"
  >
