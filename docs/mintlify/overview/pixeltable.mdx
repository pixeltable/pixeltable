...
<Steps>
  ...
  <Step title="Add Processing (Step 2)" icon="sparkles">
    Add [LLMs](/integrations/frameworks#cloud-llm-providers), [computer vision](/examples/vision/yolox), [embeddings indices](/datastore/vector-database), and build your first [multimodal app](/examples/chat/multimodal).
      <CodeGroup>
...
>
  <CardGroup cols={1}>
    ...
    <Card title="Agentic Workflows" icon="toolbox" href="/examples/chat/tools">
...
>
  <CardGroup cols={1}>
    <Card title="Video Object Detection" icon="video" href="/examples/vision/yolox">
...
>
  <CardGroup cols={1}>
    <Card title="Document Audio Synthesis" icon="file-audio" href="/examples/sample-apps">
