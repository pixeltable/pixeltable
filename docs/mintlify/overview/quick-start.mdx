...
<Note>
This guide will get you from zero to a working AI application in under 5 minutes. Learn more from the [Pixeltable Basics](/notebooks/pixeltable-basics)
and [Pixeltable Fundamentals](/notebooks/fundamentals) tutorials.
</Note>
