...
<Tip>
  Use Pixeltable directly in Google Colab: [Pixeltable Basics Tutorial](https://colab.research.google.com/github/pixeltable/pixeltable/blob/release/docs/notebooks/pixeltable-basics).
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Example Gallery" icon="images" href="/resources/sample-apps">
