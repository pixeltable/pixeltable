...
<CardGroup cols={3}>
  ...
  <Card title="Vector Database" icon="database" href="/docs/datastore/vector-database">
    Embedding index examples
  </Card>
...
<Tip>
Start with built-in Hugging Face models before creating custom embeddings. Use custom models when you need specific architectures or fine-tuned models for your domain.
</Tip>

<Note>
Need help with custom embeddings? Join our [Discord community](https://discord.com/invite/QPyqFYx2UN) for support and examples.
</Note>