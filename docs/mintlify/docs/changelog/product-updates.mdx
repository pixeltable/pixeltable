...
* Added native Model Context Protocol integration so that users can use MCP servers as a computed column.
...
* Made TableVersion timestamps con`sistent across propagated changes
