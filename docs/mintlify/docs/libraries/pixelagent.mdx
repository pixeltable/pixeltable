...
<CardGroup cols={2}>
  <Card 
    ...
    icon="brain"
    href="https://github.com/pixeltable/pixelagent/tree/main/blueprints/single-provider/anthropic/README.md"
  >
  ...
  <Card 
    title="OpenAI Agent" 
    icon="sparkles"
    href="https://github.com/pixeltable/pixelagent/tree/main/blueprints/single-provider/openai/README.md"
  >
...
<Card 
  ...
  icon="layer-group"
  href="https://github.com/pixeltable/pixelagent/tree/main/blueprints/multi-provider/README.md"
>
