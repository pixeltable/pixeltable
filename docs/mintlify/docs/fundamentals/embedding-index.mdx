...
```bash
pip install pixeltable transformers sentence_transformers tensorflow tensorflow-hub tensorflow-text
```
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Example Apps" icon="lightbulb" href="/docs/examples">
    Full applications
  </Card>
