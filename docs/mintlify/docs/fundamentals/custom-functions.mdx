...
- Create reusable components for your data pipeline

<Note>
All UDFs require type hints for parameters and return values. This enables Pixeltable to validate and optimize your data pipeline before execution.
</Note>
...
<Warning>
Always handle potential errors in UDFs to prevent pipeline failures. Pixeltable tracks exceptions but cannot recover automatically.
</Warning>
