...
<Note>
Computed columns are one of Pixeltable's most powerful features, combining automatic calculations with smart incremental updates. Think of them as your data workflow automated.
</Note>
