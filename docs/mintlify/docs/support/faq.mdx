...
<AccordionGroup>
  <Accordion title="What is Pixeltable?">
    Pixeltable is open-source AI database providing a declarative, incremental approach for multimodal workloads. It unifies data management, transformation, and AI model execution under a table-like interface. Key features:
