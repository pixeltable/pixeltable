...
<Note>
If you have a framework that you want us to integrate with, please reach out and you can also leverage Pixeltable's [UDFs](https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/feature-guides/udfs-in-pixeltable.ipynb) to build your own.
</Note>
...
<CardGroup cols={3}>
  <Card
    ...
    icon="brain"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-anthropic.ipynb"
  >
  ...
  <Card
    title="Google Gemini"
    icon="sparkles"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-gemini.ipynb"
  >
  ...
  <Card
    title="OpenAI"
    icon="square-code"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-openai.ipynb"
  >
  ...
  <Card
    title="Mistral AI"
    icon="wind"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-mistralai.ipynb"
  >
  ...
  <Card
    title="Together AI"
    icon="users"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-together.ipynb"
  >
  ...
  <Card
    title="Fireworks"
    icon="rocket"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-fireworks.ipynb"
  >
   ...
   <Card
    title="DeepSeek"
    icon="robot"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-deepseek.ipynb"
  >  
   ...
   <Card
    title="AWS Bedrock"
    icon="aws"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-bedrock.ipynb"
  >
   ...
   <Card
    title="Groq"
    icon="microchip"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-groq.ipynb"
  >
  ...
  <Card
    title="OpenRouter"
    icon="route"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-openrouter.ipynb"
  >
...
<CardGroup cols={2}>
  <Card
    title="Llama.cpp"
    icon="microchip"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-llama-cpp.ipynb"
  >
  ...
  <Card
    title="Ollama"
    icon="box"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-ollama.ipynb"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    title="Voxel51"
    icon="cube"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/working-with-fiftyone.ipynb"
  >
...
<CardGroup cols={1}>
  <Card
    title="Label Studio"
    icon="tags"
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/integrations/using-label-studio-with-pixeltable.ipynb"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="https://github.com/pixeltable/pixeltable/blob/release/docs/notebooks/fundamentals/tables-and-data-operations.ipynb"
  >
    High-performance DataFrame operations with Polars integration
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Data Import">
    ```python
    import pandas as pd
    import polars as pl
    
    # Import from pandas DataFrame
    pandas_df = pd.DataFrame({'text': ['hello', 'world'], 'score': [0.9, 0.8]})
    table = pxt.create_table('from_pandas', source=pandas_df)
    
    # Import from polars DataFrame (faster for large datasets)
    polars_df = pl.DataFrame({'text': ['hello', 'world'], 'score': [0.9, 0.8]})
    table = pxt.create_table('from_polars', source=polars_df)
    ```
  </Accordion>
</AccordionGroup>
