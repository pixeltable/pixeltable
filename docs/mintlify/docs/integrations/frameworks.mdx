...
<CardGroup cols={3}>
  ...
  >
   ...
   <Card
    title="DeepSeek"
    icon="robot"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/integrations/working-with-deepseek.ipynb"
<<<<<<< HEAD
  >
   ...
   <Card
    title="AWS Bedrock"
    icon="aws"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/integrations/working-with-bedrock.ipynb"
  >
   ...
   <Card
    title="Meta Llama"
    icon="microchip"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/integrations/working-with-llama.ipynb"
  >
    Access Meta's Llama models for text generation and embeddings
=======
  >  
    Leverage DeepSeek's powerful language and code models for text and code generation
>>>>>>> 446d711 (Fix docs integration links (#605))
  </Card>
