...
<CardGroup cols={2}>
  <Card
    title="Llama.cpp"
    icon="microchip"
    href="/integrations/local-llm/llama-cpp"
  >
  ...
  <Card
    title="Ollama"
    icon="box"
    href="/integrations/local-llm/ollama"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="face-smile"
    href="/integrations/model-hubs/huggingface"
  >
  ...
  <Card
    title="Replicate"
    icon="clone"
    href="/integrations/model-hubs/replicate"
  >
...
<CardGroup cols={1}>
  <Card
    title="Label Studio"
    icon="tags"
    href="/integrations/annotation/label-studio"
  >
