...
**Value:** `{<ChunkMetadata.TITLE: 1>: Optional[String], <ChunkMetadata.HEADING: 2>: Optional[Json], <ChunkMetadata.SOURCELINE: 3>: Optional[Int], <ChunkMetadata.PAGE: 4>: Optional[Int], <ChunkMetadata.BOUNDING_BOX: 5>: Optional[Json]}`
