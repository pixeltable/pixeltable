...
```python
pixeltable.functions.anthropic.messages(messages: Json, model: String, max_tokens: Int, model_kwargs: Optional[Json], tools: Optional[Json], tool_choice: Optional[Json]) -> Json
```
