...
```python
pixeltable.functions.huggingface.speech2text_for_conditional_generation(audio: Audio, model_id: String, language: Optional[String]) -> String
```
...
<ParamField path="language" type="Optional[String]" required>
