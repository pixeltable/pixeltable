...
<a href="https://github.com/pixeltable/pixeltable/blob/main/pixeltable/catalog/table.py#L57" target="_blank">View source on GitHub</a>
...
add_column(*,
     ...
     **kwargs: 'ts.ColumnType | builtins.type | _GenericAlias | exprs.Expr') -> 'UpdateStatus'
```
...
```python
add_embedding_index(column: 'str | ColumnRef',
     *,
     ...
     metric: 'str' = 'cosine',
     if_exists: "Literal['error', 'ignore', 'replace', 'replace_force']" = 'error') -> 'None'
```
...
```python
drop_column(column: 'str | ColumnRef',
...
```python
insert(source: 'Optional[TableDataSource]' = None,
     /,
     *,
...
```python
recompute_columns(*columns: 'str | ColumnRef',
     where: "'exprs.Expr' | None" = None,
     errors_only: 'bool' = False,
     cascade: 'bool' = True) -> 'UpdateStatus'
```
...
```python
update(value_spec: 'dict[str, Any]',
