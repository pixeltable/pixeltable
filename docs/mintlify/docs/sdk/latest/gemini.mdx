...
```python
generate_content(contents: String,
     model: String,
     config: Optional[Json],
     tools: Optional[Json]) -> Json
```
...
```python
generate_images(prompt: String,
     model: String,
     config: Optional[Json]) -> Image
```
...
```python
generate_videos(prompt: Optional[String],
     image: Optional[Image],
     model: String,
     config: Optional[Json]) -> Video
```
