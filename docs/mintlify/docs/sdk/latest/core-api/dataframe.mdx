...
```python
join(other: 'catalog.Table',
     on: 'exprs.Expr | Sequence[exprs.ColumnRef] | None' = None,
     how: 'plan.JoinType.LiteralType' = 'inner') -> 'DataFrame'
```
...
```python
sample(n: 'Optional[int]' = None,
     n_per_stratum: 'Optional[int]' = None,
     fraction: 'Optional[float]' = None,
     seed: 'Optional[int]' = None,
     stratify_by: 'Any' = None) -> 'DataFrame'
```
