...
```python
contains(self: String, substr: String, case: Bool) -> Bool
```
...
```python
contains_re(self: String, pattern: String, flags: Int) -> Bool
```
...
```python
count(self: String, pattern: String, flags: Int) -> Int
```
...
```python
fill(self: String, width: Int, **kwargs) -> String
```
...
```python
find(self: String, substr: String, start: Int, end: Optional[Int]) -> Int
```
...
```python
findall(self: String, pattern: String, flags: Int) -> Json
```
...
```python
format(self: String, *args, **kwargs) -> String
```
...
```python
fullmatch(self: String, pattern: String, case: Bool, flags: Int) -> Bool
```
...
```python
index(self: String, substr: String, start: Int, end: Optional[Int]) -> Int
```
...
```python
lstrip(self: String, chars: Optional[String]) -> String
```
...
```python
match(self: String, pattern: String, case: Bool, flags: Int) -> Bool
```
...
```python
pad(self: String, width: Int, side: String, fillchar: String) -> String
```
...
```python
replace(self: String, substr: String, repl: String, n: Optional[Int]) -> String
```
...
```python
replace_re(self: String, pattern: String, repl: String, n: Optional[Int], flags: Int) -> String
```
...
```python
rfind(self: String, substr: String, start: Optional[Int], end: Optional[Int]) -> Int
```
...
```python
rindex(self: String, substr: String, start: Optional[Int], end: Optional[Int]) -> Int
```
...
```python
rstrip(self: String, chars: Optional[String]) -> String
```
...
```python
slice(self: String, start: Optional[Int], stop: Optional[Int], step: Optional[Int]) -> String
```
...
```python
slice_replace(self: String, start: Optional[Int], stop: Optional[Int], repl: Optional[String]) -> String
```
...
```python
strip(self: String, chars: Optional[String]) -> String
```
...
```python
wrap(self: String, width: Int, **kwargs) -> Json
```
