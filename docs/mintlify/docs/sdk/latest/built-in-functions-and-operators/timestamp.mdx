...
```python
isoformat(self: Timestamp, sep: String, timespec: String) -> String
```
...
```python
make_timestamp(year: Int, month: Int, day: Int, hour: Int, minute: Int, second: Int, microsecond: Int) -> Timestamp
```
...
```python
replace(self: Timestamp, year: Optional[Int], month: Optional[Int], day: Optional[Int], hour: Optional[Int], minute: Optional[Int], second: Optional[Int], microsecond: Optional[Int]) -> Timestamp
```
