...
description: 'Stop choosing between months of data infrastructure work or limited AI frameworks. Pixeltable gives you a **declarative**, **incremental** approach for building **multimodal** AI products in days, not months.'
icon: "rocket"
---
