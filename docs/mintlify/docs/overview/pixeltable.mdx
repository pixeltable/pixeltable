---
title: 'Introduction'
description: 'Pixeltable is a declarative database for building multimodal AI applications, enabling incremental storage, transformation, indexing, and orchestration of data.'
icon: "rocket"
---
