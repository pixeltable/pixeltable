...
description: 'Stop choosing between months of infrastructure work and limited frameworks. Pixeltable gives you a **declarative**, **incremental** approach for **multimodal** AI products in days, not months.'
icon: "rocket"
---
...
>
  - All your AI data & models in one table interface
</Card>
...
>
  - An declarative interface for all your AI workloads
</Card>
</CardGroup>
...
<Steps>
  <Step title="Start Building (Step 1)" icon="code">
    ...
    ```
    Get up and running with basic [tables](/docs/datastore/tables-and-operations), [queries](/docs/ai-apps/filtering-and-selecting), and [computed columns](docs/datastore/computed-columns).
  ...
  <Step title="Add Processing (Step 2)" icon="sparkles">
    Add [LLMs](docs/integrations/frameworks#cloud-llm-providers), [computer vision](/docs/examples/vision/yolox), [embeddings indices](docs/datastore/embedding-index), and build your first [multimodal chatbot](/docs/examples/chat/multimodal).
      <CodeGroup>
  ...
  <Step title="Scale Up (Step 3" icon="chart-mixed">
    Handle [production data](/docs/ai-apps/bringing-data) volumes, and deploy your application.
      <CodeGroup>
    ```python bring cloud data
    # Import media datad (videos, images, audio...)
...
>
  <CardGroup cols={1}>
    <Card title="Multimodal RAG Chatbot" icon="brain-circuit" href="https://huggingface.co/spaces/Pixeltable/Multi-LLM-RAG-with-Groundtruth-Comparison">
    ...
    <Card title="Document Analysis Bot" icon="file-search" href="https://huggingface.co/spaces/Pixeltable/Document-to-Audio-Synthesis">
      Convert and analyze documents with multimodal processing.
    </Card>
  </CardGroup>
</Card>
...
>
  <CardGroup cols={1}>
    ...
    <Card title="Visual Search Engine" icon="magnifying-glass" href="https://huggingface.co/spaces/Pixeltable/Text-and-Image-similarity-search-nextjs-fastapi">
...
>
  <CardGroup cols={1}>
    <Card title="Document Audio Synthesis" icon="file-audio" href="https://huggingface.co/spaces/Pixeltable/Document-to-Audio-Synthesis">
...
>
  <CardGroup cols={1}>
    ...
    <Card title="Financial Analysis" icon="chart-line" href="https://huggingface.co/spaces/Pixeltable/AI-Financial-Analysis-Platform">
...
<CardGroup cols={3}>
  <Card 
    ...
    icon="rocket" 
    href="https://huggingface.co/Pixeltable"
  >
    Check out our Hugging Face demos
  </Card>
  <Card 
    title="Join Discord" 
    icon="discord" 
    href="https://discord.gg/6MnmFYZJ9N"
  >
