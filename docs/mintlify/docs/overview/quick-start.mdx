...
## Create Your First Multimidal AI Application
...
<Steps>
  <Step title="Create Table Structure">
    ...
    <Tip>
    This creates a persistent and verstioned table that holds data.
    </Tip>
  </Step>
...
<CardGroup cols={3}>
  <Card title="RAG Tutorial" icon="books" href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/use-cases/rag-demo.ipynb">
    Build a production-grade RAG system
  </Card>
  <Card title="Video Analysis" icon="video" href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/use-cases/object-detection-in-videos.ipynb">
