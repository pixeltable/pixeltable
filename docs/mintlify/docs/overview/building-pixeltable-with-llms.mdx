...
For example, you can find the plain text version of this page itself at [https://docs.pixeltable.com/docs/overview/building-pixeltable-with-llms.md](https://docs.pixeltable.com/docs/overview/building-pixeltable-with-llms.md).
