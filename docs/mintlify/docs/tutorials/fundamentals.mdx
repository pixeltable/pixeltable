...
<CardGroup cols={3}>
  <Card
    ...
    icon="database"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/fundamentals/tables-and-data-operations.ipynb"
  >
  ...
  <Card
    ...
    icon="calculator"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/fundamentals/computed-columns.ipynb"
  >
    Leverage Pixeltable's powerful computed columns to automate data transformations, integrate ML models, and create dynamic data pipelines with automatic versioning and lineage tracking
  </Card>

  <Card
    title="Queries & Expressions"
    icon="magnifying-glass"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/fundamentals/queries-and-expressions.ipynb"
  >
