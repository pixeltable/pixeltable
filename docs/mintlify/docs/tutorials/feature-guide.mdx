...
<CardGroup cols={2}>
  <Card
    ...
    icon="file-image"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/feature-guides/working-with-external-files.ipynb"
  >
  ...
  <Card
    ...
    icon="code"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/feature-guides/udfs-in-pixeltable.ipynb"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="database"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/feature-guides/embedding-indexes.ipynb"
  >
  ...
  <Card
    ...
    icon="clock"
    href="https://github.com/pixeltable/pixeltable/blob/main/docs/notebooks/feature-guides/time-zones.ipynb"
  >
...
<Note>
  These guides assume basic familiarity with Pixeltable. New to Pixeltable? Start with our [Getting Started Guide](/docs/getting-started) or join our [Discord community](https://discord.gg/6MnmFYZJ9N) for help.
</Note>