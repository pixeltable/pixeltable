...
We'll build an applications that analyzes Eadweard Muybridge's horse galloping sequence building public domain images that bridge photography and motion pictures Each step introduces a new Pixeltable concept.
