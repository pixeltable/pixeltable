...
# Building a PDF Search Pipeline
...
<Steps>
  ...
  <Step title="Define Your Pipeline" icon="diagram-project">
    Create `schema.py`:
    ```python
  ...
  <Step title="Use Your Pipeline" icon="play">
    ...
    documents_chunks = pxt.get_view("pdf_search.document_chunks")
...
<CardGroup cols={2}>
  <Card title="Chunking Strategies" icon="puzzle-piece" href="/docs/pdf/chunking">
    Learn about different text chunking approaches
  </Card>
  <Card title="Search Optimization" icon="gauge-high" href="/docs/pdf/optimization">
    Optimize your document search for better results
  </Card>
</CardGroup>