---
title: "Label Studio"
description: "Build annotation pipelines with Pixeltable and Label Studio in two phases"
icon: "circle-play"
---
...
1. Define your annotation pipeline (once)
...
<CardGroup cols={1}>
  ...
  <Card title="Incremental Updates" icon="arrows-rotate">
    New data automatically flows through pipeline:
    ```python
