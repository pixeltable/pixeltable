...
<CardGroup cols={3}>
  <Card title="Audio" icon="volume-high" href="/notebooks/use-cases/audio-transcriptions">
    Build semantic search for audio files and podcasts
  </Card>
  <Card title="Document" icon="file-pdf" href="/notebooks/use-cases/rag-demo">
    Search through PDFs and other document formats
  </Card>
  <Card title="Video" icon="film" href="/notebooks/use-cases/object-detection-in-videos">
...
<CardGroup cols={3}>
  ...
  <Card title="Embedding Indexes" icon="lightbulb" href="/notebooks/feature-guides/embedding-indexes">
