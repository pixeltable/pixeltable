...
video_table = pxt.create_table(f'{config.APP_NAMESPACE}.videos', {'video': pxt.Video}, if_exists='ignore')
...
image_table = pxt.create_table(
    f'{config.APP_NAMESPACE}.images', {'image': pxt.Image, 'tags': pxt.Json}, if_exists='ignore'
)
