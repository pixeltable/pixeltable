...
class MultimodalEcsStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        secret = secretsmanager.Secret(
            ...
            secret_object_value={
                "OPENAI_API_KEY": SecretValue.unsafe_plain_text(os.getenv("OPENAI_API_KEY")),
            }
        )
