...
- PyTorch: [`query.to_pytorch_dataset()`](/sdk/latest/query#method-to-pytorch-dataset) for ML training pipelines
- COCO: [`query.to_coco_dataset()`](/sdk/latest/query#method-to-coco-dataset) for computer vision
- Pandas: [`query.collect().to_pandas()`](/sdk/latest/query#method-collect) for analysis
