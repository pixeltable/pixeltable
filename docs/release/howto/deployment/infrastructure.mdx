...
├── app.py                 # Models and services, run by pxt service
...
- **Built-in HTTP serving:** For standard endpoints, consider [`pxt service`](/howto/deployment/serving) with an application file.
