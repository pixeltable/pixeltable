...
<Steps>
  ...
  <Step title="Export it">
    ...
    [Configuration](/platform/configuration). This key authenticates Cloud CLI and hosted HTTP. Provider keys such as `OPENAI_API_KEY` go under **Secrets** in the dashboard, not here.
  </Step>
</Steps>
