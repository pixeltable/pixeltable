...
<Tabs>
  ...
  <Tab title="Example">
    ...
    # Or set destination per computed column
    t.add_computed_column(
        audio=pxt.functions.video.extract_audio(t.video, format='mp3'),
        destination='gs://my-gcs-bucket/audio/'
    )
    ```
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Example">
    ...
    # Or set destination per computed column
    t.add_computed_column(
        thumbnail=t.image.resize([224, 224]),
        destination='wasbs://mycontainer@myaccount.blob.core.windows.net/thumbnails/'
    )
    ```
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Example">
    ...
    t.add_computed_column(
        ...
        destination='https://s3.us-west-004.backblazeb2.com/my-bucket/audio/',
    )
    ```
  </Tab>
</Tabs>
