...
<CardGroup cols={2}>
  <Card
    ...
    icon="face-smile"
    href="/cookbooks/local-models/working-with-hugging-face"
  >
  ...
  <Card
    title="Replicate"
    icon="clone"
    href="/cookbooks/providers/working-with-replicate"
  >
...
<Tip>
Need help choosing the right model? Check our [example notebooks](https://github.com/pixeltable/pixeltable/tree/main/docs/cookbooks/providers) or join our [Discord community](https://discord.com/invite/QPyqFYx2UN).
</Tip>