...
The skill is [pixeltable/pixeltable-skill](https://github.com/pixeltable/pixeltable-skill), and [docs.pixeltable.com/skill.md](https://docs.pixeltable.com/skill.md) points there. Install it:
