  ...
  <Tab title="4. Share & Export">
    <Steps>
      ...
      <Step title="Export" icon="file-export">
        Training formats: [`to_pytorch_dataset()`](/sdk/latest/query#method-to_pytorch_dataset), [`export_parquet()`](/sdk/latest/io#func-export_parquet), [`to_coco_dataset()`](/sdk/latest/query#method-to_coco_dataset), [`export_lancedb()`](/sdk/latest/io#func-export_lancedb)
