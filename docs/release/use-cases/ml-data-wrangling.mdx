  ...
  <Tab title="1. Acquire Data">
    <Steps>
      <Step title="Ingest" icon="download">
        Load from any source: [`import_csv()`](/sdk/latest/io#func-import_csv), [`import_parquet()`](/sdk/latest/io#func-import_parquet), [`import_sql()`](/howto/cookbooks/data/data-export-sql), [HuggingFace](/howto/cookbooks/data/data-import-huggingface), [S3/GCS/Azure](/integrations/cloud-storage)
    ...
    <Steps>
      ...
      <Step title="Annotate" icon="user">
        **Human-in-the-loop:** Refine labels with human annotators
        ...
        [FiftyOne](/howto/working-with-fiftyone) export, [`add_embedding_index()`](/platform/embedding-indexes) for curation search
