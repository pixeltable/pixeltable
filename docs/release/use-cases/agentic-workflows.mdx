...
[Tool calling](/howto/cookbooks/agents/llm-tool-calling) · [Agentic patterns](/howto/cookbooks/agents/agentic-patterns) · [RAG pipeline](/howto/cookbooks/agents/pattern-rag-pipeline) · [HTTP serving](/howto/deployment/serving)
