  ...
  <Tab title="5. Deploy">
    <Steps>
      ...
      <Step title="Deploy" icon="cloud">
        Serve your agent with `pxt service update`. Same file on Cloud: `pxt schema update app.py pxt://org:db`. `pxt service` stays local. [Deploy to Pixeltable Cloud](/howto/deployment/cloud).
