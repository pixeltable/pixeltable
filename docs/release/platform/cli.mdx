...
pxt secret list                  # the secrets your org holds
```
...
```bash
pxt org status                   # your default organization
pxt org status pxt://myorg       # a specific one
```
...
```bash
pxt secret list                    # your default organization
