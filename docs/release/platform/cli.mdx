...
a line reaches it a few seconds after it is written. A service running on this machine logs to a file there
instead, and asking for its log reports where that file is.
