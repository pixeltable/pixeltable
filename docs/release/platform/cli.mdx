...
Path components are case-insensitive: `pxt ls MyDir` and `pxt ls mydir` list the same directory, and `pxt ls` prints the lower-cased name. See [Identifiers and Naming](/platform/identifiers).
