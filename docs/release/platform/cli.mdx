...
Database URIs use the form `pxt://org:db`. Valid states: `PROVISIONING`, `AVAILABLE`, `STOPPING`, `STOPPED`, `UPDATING`, `FAILED`.
...
Show the organization's default database and creation timestamp.
