...
Defines which project files the database gets, what its image holds, what it runs on, where its media goes, where it exports telemetry, and which secrets it holds.
