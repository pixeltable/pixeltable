...
Defines which project files the database gets, what its image holds, what it runs on, where its media goes, and where and how it exports telemetry.
...
input_media_dest = 's3://bucket/input/'
output_media_dest = 's3://bucket/output/'

# the OpenTelemetry exporter; set its auth headers with pxt secret set
exporter_otlp_endpoint = 'https://otlp.example.com'
exporter_otlp_protocol = 'http/protobuf'  # or 'grpc'
