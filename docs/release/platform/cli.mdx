...
Defines which project files the database gets, what goes into its image, its compute settings, where its media goes, and where and how it exports telemetry.
