...
| `pxt.UUID` | `uuid.UUID` | Universally unique identifiers |
...
<CardGroup cols={2}>
  <Card title="Tables" icon="table" href="/platform/tables">
    Creating and managing tables
  </Card>
  <Card title="Computed Columns" icon="calculator" href="/platform/computed-columns">
