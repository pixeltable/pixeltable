...
<CardGroup cols={3}>
  <Card title="Audio" icon="volume-high" href="/cookbooks/av/audio-transcriptions">
    Build semantic search for audio files and podcasts
  </Card>
  <Card title="Document" icon="file-pdf" href="/cookbooks/app-workflows/rag-demo">
    Search through PDFs and other document formats
  </Card>
  <Card title="Video" icon="film" href="/cookbooks/av/object-detection-in-videos">
