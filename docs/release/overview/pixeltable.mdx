...
```
┌─────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│  STORE              ORCHESTRATE              INDEX                QUERY                 DELIVER         │
│                                                                                                         │
│  ┌─────────────┐    ┌─────────────────┐    ┌──────────────┐    ┌────────────┐    ┌─────────────────┐   │
│  │ Video/Image │───▶│ Computed Columns│───▶│  Embeddings  │───▶│  SQL-like  │───▶│ Export (ML)     │   │
│  │ Audio/Doc   │    │ API calls (LLM) │    │  Similarity  │    │  Filter    │    │ Serve (Apps)    │   │
│  │ JSON/Text   │    │ Local inference │    │  Auto-sync   │    │  Aggregate │    │ Tools (Agents)  │   │
│  └─────────────┘    └─────────────────┘    └──────────────┘    └────────────┘    └─────────────────┘   │
│       Tables          Incremental           Vector search       Experiment       PyTorch / FastAPI /   │
│                       Dependencies          RAG retrieval       Iterate          MCP / Pre-signed URLs │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
