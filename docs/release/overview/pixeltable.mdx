...
<CardGroup cols={2}>
  <Card title="Fragmented Storage" icon="layer-group" iconType="duotone">
    Videos in S3, embeddings in Pinecone, metadata in Postgres. No transactions, no concurrency, batch-only.
  </Card>
  <Card title="DIY Orchestration" icon="screwdriver-wrench" iconType="duotone">
    Custom code wiring tools. Cron jobs for every step. No dependency tracking, manual error handling.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Pixeltable Cloud" icon="cloud" iconType="duotone" href="/use-cases/services">
    Data sharing, managed endpoints, and collaboration. Start local, scale to cloud when ready.
  </Card>
</CardGroup>

<Card title="Talk to Us" icon="calendar" iconType="duotone" href="https://cal.com/pixeltable/30min">
