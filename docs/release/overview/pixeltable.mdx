...
<CardGroup cols={2}>
  ...
  <Card title="Multimodal RAG" icon="magnifying-glass">
    Production RAG with automatic embedding indexing, semantic search, and incremental updates across text, images, and video.
  </Card>
  ...
  <Card title="ML Data Export" icon="download">
    Export to PyTorch DataLoaders, Parquet, COCO format, LanceDB, and pandas for training and analytics.
  </Card>
</CardGroup>
...
<CardGroup cols={4}>
  ...
  <Card title="Agent Memory" icon="clock-rotate-left" href="/howto/cookbooks/agents/pattern-agent-memory">
