...
<AccordionGroup>
  ...
  <Accordion title="Orchestrate" icon="robot">
    **Tool calling for AI agents and MCP integration**
    
    ```python
    # Expose functions as LLM tools
    tools = pxt.tools(search_by_topic, extract_entities)
...
<Tip>
Explore the **[Cookbooks](/howto/cookbooks/core/dev-iterative-workflow)** for hands-on tutorials: RAG pipelines, video analysis, audio transcription, image processing, and more.
</Tip>
