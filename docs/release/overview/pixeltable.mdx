  ...
  <Accordion title="Agents & Tools" icon="robot">
    **Tool calling for AI agents and MCP integration**
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Agentic workflows" icon="plug" href="/use-cases/agentic-workflows">
...
<CardGroup cols={3}>
  <Card title="Multimodal backend" icon="microchip-ai" href="/use-cases/multimodal-backend">
    Build pipelines that add multimodal intelligence to applications — RAG, search, and live APIs.
  </Card>
  <Card title="Agentic workflows" icon="robot" href="/use-cases/agentic-workflows">
    Tool calling, persistent memory, and MCP server integration for autonomous agents.
  </Card>
  <Card title="Media processing" icon="flask" href="/use-cases/media-processing">
    Process video, audio, documents, and images into training-ready datasets.
  </Card>
</CardGroup>
