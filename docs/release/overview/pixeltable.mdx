...
<CardGroup cols={2}>
  ...
  <Card title="Multimodal Workloads" icon="magnifying-glass">
    Production RAG with automatic embedding indexing, Find relevant scenes of a video, semantic search, and incremental updates
  </Card>
