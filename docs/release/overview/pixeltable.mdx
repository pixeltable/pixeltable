...
│                   │     │                                                       │     │                   │
│  Structured Data  │     │  Pre-process      Generate           Post-process    │     │  Query & Serve    │
│  ───────────────  │     │  ────────────     ────────           ────────────    │     │  ─────────────    │
│  • Tables         │     │  • Extract        • LLM calls        • Aggregate     │     │  • SQL-like       │
│  • Video/Image    │────▶│  • Chunk/Split    • Local inference  • Format        │────▶│  • Similarity     │
│  • Audio/Doc      │     │  • Validate       • Embeddings       • Index         │     │  • Export (ML)    │
│  • JSON/Text      │     │                                                       │     │  • Share/Publish  │
│                   │     │  ┌─────────────────────────────────────────────────┐ │     │  • Tools/MCP      │
│  Versioned        │     │  │ Computed Columns: incremental, dependency-aware │ │     │  • FastAPI        │
│  Persistent       │     │  └─────────────────────────────────────────────────┘ │     │                   │
└───────────────────┘     └───────────────────────────────────────────────────────┘     └───────────────────┘
```
