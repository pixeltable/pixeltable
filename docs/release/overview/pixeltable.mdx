...
│                                                                                                │
│  ┌─────────────┐    ┌─────────────────┐    ┌──────────────┐    ┌────────────┐    ┌──────────┐ │
│  │ Video/Image │───▶│ Computed Columns│───▶│  Embeddings  │───▶│  SQL-like  │───▶│ PyTorch  │ │
│  │ Audio/Doc   │    │ API calls (LLM) │    │  Similarity  │    │  Filter    │    │ Parquet  │ │
│  │ JSON/Text   │    │ Local inference │    │  Auto-sync   │    │  Aggregate │    │ COCO     │ │
│  └─────────────┘    └─────────────────┘    └──────────────┘    └────────────┘    └──────────┘ │
│       Tables         Incremental updates    Vector search       Experiment        ML-ready    │
└────────────────────────────────────────────────────────────────────────────────────────────────┘
```
