...
6. **Prototype with TOML first.** [`pxt serve`](/howto/deployment/serving) with `[[pixeltable.service.routes]]` in the Pixeltable config file is the fastest way to test a new route before wiring it into your app.
...
<CardGroup cols={2}>
  ...
  <Card title="Multimodal backend" icon="brain" href="/use-cases/multimodal-backend">
