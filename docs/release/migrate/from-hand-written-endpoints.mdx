...
6. **Prototype declaratively first.** [`pxt service`](/howto/deployment/serving) over an application file is the fastest way to test a new route before wiring it into your app.
