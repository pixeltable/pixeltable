...
news_agent.add_computed_column(final_response=chat_completions(model=OPENAI_MODEL, messages=messages))

news_agent.add_computed_column(answer=news_agent.final_response.choices[0].message.content)
