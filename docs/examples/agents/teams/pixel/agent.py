...
def setup_agent_table(agent_table: pxt.Table, agent_tools: pxt.tools, system_prompt: str):
...
def create_agent(agent_name: str, agent_tools: pxt.tools, system_prompt: str, purge: bool = False) -> pxt.Table:
