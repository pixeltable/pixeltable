...
.PHONY: typecheck
typecheck: install
	@mypy pixeltable/*.py pixeltable/catalog pixeltable/ext pixeltable/func pixeltable/functions pixeltable/index pixeltable/iterators pixeltable/metadata pixeltable/utils
