...
def run(argv: list[str]) -> None:
    parser = Parser(prog='pxt service start', description='Start a service in a hosted database.')
    ...
    try:
        ...
        resp = post(f'/api/orgs/{org_slug}/dbs/{db_slug}/services/{svc_name}/start', {})
