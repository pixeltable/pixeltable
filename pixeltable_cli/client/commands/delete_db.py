...
from pixeltable_cli.utils import parse_db_uri
...
def run(argv: list[str]) -> None:
    parser = Parser(prog='pxt db delete', description='Delete a hosted Pixeltable database.')
    ...
    try:
        ...
        post(f'/api/orgs/{org_slug}/dbs/{db_slug}/delete', {})
        if args.json_output:
