...
holds (system_dependencies, python_version) and what the database runs on (cpu, memory_mb, disk_gb,
workers). 'diff' compares the entry against the database; 'update' applies the difference.
