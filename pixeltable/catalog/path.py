...
class Path:
    ...
    def __post_init__(self) -> None:
        # fold before validating: identifiers are case-insensitive and the folded form is what gets stored.
        # (frozen dataclass, so assignment goes through object.__setattr__)
