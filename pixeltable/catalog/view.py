...
class View(Table):
    ...
    def create(
            ...
            predicate: 'exprs.Predicate', is_snapshot: bool, num_retained_versions: int,
        ...
        with orm.Session(Env.get().engine, future=True) as session:
            ...
            id, tbl_version = TableVersion.create(
                session, dir_id, name, columns, num_retained_versions, base_path=base_version_path, view_md=view_md)
