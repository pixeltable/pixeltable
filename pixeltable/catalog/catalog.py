...
class Catalog:
    ...
    @retry_loop(for_write=False)
    def collect_tbl_history(self, tbl_id: UUID, n: Optional[int]) -> list[TableVersionCompleteMd]:
        """
    ...
    def load_tbl_md(self, tbl_id: UUID, effective_version: Optional[int]) -> TableVersionCompleteMd:
        """
