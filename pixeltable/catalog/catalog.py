...
class Catalog:
    ...
    def construct_tvp(
        self, tbl_id: UUID, version: int, live_ancestors: schema.TableVersionPath, created_at: float
    ) -> TableVersionPath:
        """
        ...
        for ancestor_id, ancestor_version in live_ancestors:
    ...
    def load_tbl_md(self, key: TableVersionKey) -> TableVersionCompleteMd:
        """
