...
_shared_rate_limits = {
    'gpt-3.5-turbo': [
        ...
        'gpt-3.5-turbo-0301',
        'gpt-3.5-turbo-0613',
        'gpt-3.5-turbo-0613-shared',
        'gpt-3.5-turbo-1106',
        'gpt-3.5-turbo-1106-shared',
        'gpt-3.5-turbo-0125',
        'gpt-3.5-turbo-0125-shared',
    ],
    ...
    'gpt-4': ['gpt-4', 'gpt-4-0125-preview', 'gpt-4-0314', 'gpt-4-0613', 'gpt-4-0613-shared'],
    'gpt-4.1': ['gpt-4.1', 'gpt-4.1-2025-04-14', 'gpt-4.1-2025-04-14-shared'],
    'gpt-4.1-mini': ['gpt-4.1-mini', 'gpt-4.1-mini-2025-04-14', 'gpt-4.1-mini-2025-04-14-shared'],
    'gpt-4.1-nano': ['gpt-4.1-nano', 'gpt-4.1-nano-2025-04-14', 'gpt-4.1-nano-2025-04-14-shared'],
    'gpt-4o': [
        'gpt-4o',
        'gpt-4o-2024-05-13',
        'gpt-4o-2024-05-13-shared',
        'gpt-4o-2024-08-06',
        'gpt-4o-2024-08-06-alpha',
        'gpt-4o-2024-08-06-alpha-shared',
        'gpt-4o-2024-08-06-shared',
        'gpt-4o-2024-11-20',
    ...
    'gpt-4o-mini': [
        ...
        'gpt-4o-mini-2024-07-18-shared',
        'gpt-4o-mini-2024-07-18-alpha-shared',
        'gpt-4o-mini-audio-preview',
        'gpt-4o-mini-audio-preview-2024-12-17',
    ],
    'gpt-4o-mini-search-preview': ['gpt-4o-mini-search-preview', 'gpt-4o-mini-search-preview-2025-03-11'],
    'gpt-4o-search-preview': ['gpt-4o-search-preview', 'gpt-4o-search-preview-2025-03-11'],
    'gpt-5': ['gpt-5', 'gpt-5-2025-08-07'],
    'gpt-5-mini': ['gpt-5-mini', 'gpt-5-mini-2025-08-07'],
    'gpt-5-nano': ['gpt-5-nano', 'gpt-5-nano-2025-08-07'],
    'gpt-5-pro': ['gpt-5-pro', 'gpt-5-pro-2025-10-06', 'gpt-5-pro-alpha-2025-09-15'],
    'gpt-5-search-api': ['gpt-5-search-api', 'gpt-5-search-api-2025-10-14'],
    'gpt-5.1': ['gpt-5.1', 'gpt-5.1-2025-11-13'],
    'gpt-5.2': ['gpt-5.2', 'gpt-5.2-2025-12-11'],
    'gpt-5.2-pro': ['gpt-5.2-pro', 'gpt-5.2-pro-2025-12-11'],
    'gpt-5.4': ['gpt-5.4', 'gpt-5.4-2026-03-05'],
    'gpt-5.4-pro': ['gpt-5.4-pro', 'gpt-5.4-pro-2026-03-05'],
    'o1': ['o1', 'o1-2024-10-13', 'o1-2024-12-02-alpha', 'o1-2024-12-17', 'o1-2024-12-17-v2', 'o1-2024-12-17-v3'],
    'o1-pro': ['o1-pro', 'o1-pro-2025-03-19'],
    'o3': ['o3', 'chatgpt-o-latest', 'o3-2025-04-16'],
    'o3-deep-research': ['o3-deep-research', 'o3-deep-research-2025-05-28'],
    'o3-mini': ['o3-mini', 'o3-mini-2024-12-17', 'o3-mini-2025-01-31', 'o3-mini-2025-01-31-shared'],
    'o3-pro': ['o3-pro', 'o3-pro-2025-06-10'],
    'o4-mini': ['o4-mini', 'chatgpt-o-mini-latest', 'o4-mini-2025-04-16', 'o4-mini-2025-04-16-shared'],
    'text-embedding-ada-002': ['text-embedding-ada-002', 'text-embedding-ada-002-v2'],
    'computer-use-preview': ['computer-use-preview', 'computer-use-preview-2025-03-11'],
}
