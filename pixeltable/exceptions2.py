...
RequestError              422   INVALID_COLUMN_NAME, INVALID_PATH,
                          ...
                          400   UNSUPPORTED_OPERATION, INVALID_STATE,
                                IMMUTABLE
AuthorizationError        403   INSUFFICIENT_PRIVILEGES, MISSING_CREDENTIALS
...
HTTP_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.MISSING_CREDENTIALS: 403,
    # ExternalServiceError (5xxx)
...
class ExternalServiceError(Error):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(message, error_code=error_code, retryable=retryable, cause=cause)
