...
def __substitute_md(k: str | None, v: Any) -> tuple[str | None, Any] | None:
    ...
    #
    # Old (v50): the column's physical owner (tbl_id/tbl_version) plus a separate reference_tbl path that carried
    #   the access context (the view/snapshot the column was reached through).
    # New (v51): the path-context table (tbl_id/effective_version) and the column's physical owner
