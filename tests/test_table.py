...
class TestTable:
    ...
    def test_create_if_exists(self, reset_db: None, reload_tester: ReloadTester) -> None:
        ...
        for _ie in ['ignore', 'replace', 'replace_force']:
            ...
            assert 'already exists' in str(exc_info.value) and 'is not a Table' in str(exc_info.value)
    ...
    def test_media_validation(self, reset_db: None) -> None:
        ...
        with pytest.raises(excs.Error) as exc_info:
            _ = pxt.create_table('validation_error', {'img': pxt.Image}, media_validation='wrong_value')
    ...
    def test_validate_on_read(self, reset_db: None) -> None:
        ...
        on_read_res = on_read_tbl.select(
            on_read_tbl.media,
        ...
        on_write_res = on_write_tbl.select(
            on_write_tbl.media,
    ...
    def check_bad_media(self, rows: list[tuple[str, bool]], col_type: type, validate_local_path: bool = True) -> None:
        schema = {
            'media': col_type,
    ...
    def test_validate_json(self, reset_db) -> None:
        ...
        t = pxt.create_table('test', {'json_col': pxt.Json[json_schema]})
