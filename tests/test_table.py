...
class TestTable:
    ...
    def _validate_repr(self, t: Any, expected: str) -> None:
        ...
        assert cleanup(repr(t)) == cleanup(expected), repr(t)
    ...
    def test_repr(self, uses_db: None, test_tbl: pxt.Table, all_mpnet_embed: pxt.Function) -> None:
        ...
        self._validate_repr(
            ...
            Column Name                            Type         Source           Computed With
                    pos                   Required[Int]  DummyIterator
                   out1                Required[String]  DummyIterator
                   out2                   Required[Int]  DummyIterator
              computed1  Required[Array[(3, 4), int64]]   test_subview            <lambda>(c2)
                     c1                Required[String]       test_tbl
                    c1n                          String       test_tbl
                     c2                   Required[Int]       test_tbl
        ...
        self._validate_repr(
            ...
            view 'iterator_view_2' (of 'iterator_view_1', 'test_subview:3', 'test_view:0', 'test_tbl:2')
                      ...
                      Column Name                            Type          Source                      Computed With
                              pos                   Required[Int]  DummyIterator2
                             out1                Required[String]  DummyIterator2
                             out2                   Required[Int]  DummyIterator2
            iterator_view_2_col_1                Required[String]                                 ('"' + out1) + '"'
            iterator_view_2_col_2                 Required[Float]                  stock_price(iterator_view_2_col_1)
                        computed1  Required[Array[(3, 4), int64]]    test_subview                        <lambda>(c2)
                               c1                Required[String]        test_tbl
                              c1n                          String        test_tbl
                               c2                   Required[Int]        test_tbl
