...
class TestQuery:
    ...
    def test_join(self, uses_store: None) -> None:
        num_rows = 1000
    ...
    def test_join_errors(self, uses_store: None) -> None:
    ...
    def test_html_media_url(self, uses_store: None) -> None:
    ...
    def test_to_coco(self, uses_store: None) -> None:
    ...
    def test_distinct(self, uses_store: None, reload_tester: ReloadTester) -> None:
    ...
    def test_to_pydantic(self, uses_store: None) -> None:
