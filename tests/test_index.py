...
class TestIndex:
    ...
    def test_string_btree(self, make_catalog_path: Callable[[str], str], catalog_mode: CatalogMode) -> None:
    ...
    def test_timestamp_btree(self, make_catalog_path: Callable[[str], str], catalog_mode: CatalogMode) -> None:
        if catalog_mode == 'cloud':
