...
class TestSample:
    ...
    def test_sample_basic_n(self, uses_store: None) -> None:
    ...
    def test_sample_basic_f(self, uses_store: None) -> None:
        t = self.create_sample_data(4, 6, False)
        t_rows = t.count()
    ...
    def test_sample_snapshot_reload(self, uses_store: None, reload_tester: ReloadTester) -> None:
        t = self.create_sample_data(4, 6, False)
    ...
    def test_sample_stratified_n(self, uses_store: None) -> None:
    ...
    def test_sample_stratified_f(self, uses_store: None) -> None:
        t = self.create_sample_data(4, 6, True)
        t_rows = t.count()
    ...
    def test_sample_snapshot(self, uses_store: None, seed: int) -> None:
        t = self.create_sample_data(4, 6, True)
        t_rows = t.count()
    ...
    @pytest.mark.parametrize('seed', [None, 4171780])
    def test_sample_snapshot_stratified(self, uses_store: None, seed: int) -> None:
        t = self.create_sample_data(4, 6, True)
        t_rows = t.count()
    ...
    def test_randomized_sample(self, uses_store: None) -> None:
    ...
    def test_reproducible_sample(self, uses_store: None) -> None:
        t = self.create_sample_data(4, 6, False)
    ...
    def test_sample_view(self, uses_store: None) -> None:
        t = self.create_sample_data(4, 6, False)
    ...
    def test_sample_iterator(self, uses_store: None) -> None:
