...
class TestDocument:
    ...
    def test_doc_splitter_errors(self, uses_store: None) -> None:
    ...
    def test_doc_splitter(self, pdf: bool, uses_store: None) -> None:
    ...
    def test_doc_splitter_headings(self, uses_store: None) -> None:
        skip_test_if_not_installed('spacy')
        file_paths = [
    ...
    def test_doc_splitter_txt(self, uses_store: None) -> None:
    ...
    def test_doc_splitter_images(self, uses_store: None) -> None:
