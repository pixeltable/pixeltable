...
class TestView:
    ...
    def test_basic(self, do_reload_catalog: bool, uses_store: None) -> None:
        t = self.create_tbl()
    ...
    def test_add_column_to_view(self, uses_store: None, test_tbl: pxt.Table, reload_tester: ReloadTester) -> None:
    ...
    def test_from_query(self, uses_store: None) -> None:
        t = self.create_tbl()
    ...
    def test_parallel_views(self, uses_store: None) -> None:
    ...
    def test_chained_views(self, uses_store: None) -> None:
    ...
    def test_unstored_columns_non_image(self, uses_store: None) -> None:
        t = self.create_tbl()
        print(t)
    ...
    def test_unstored_columns(self, uses_store: None) -> None:
    ...
    def test_selected_cols(self, uses_store: None, reload_tester: ReloadTester) -> None:
        t = self.create_tbl()
    ...
    @pytest.mark.parametrize('do_reload_catalog', [False, True])
    def test_computed_cols(self, do_reload_catalog: bool, uses_store: None) -> None:
        t = self.create_tbl()
    ...
    @pytest.mark.parametrize('do_reload_catalog', [False, True])
    def test_filter(self, do_reload_catalog: bool, uses_store: None) -> None:
        t = create_test_tbl()
    ...
    @pytest.mark.parametrize('do_reload_catalog', [False, True])
    def test_view_of_snapshot(self, do_reload_catalog: bool, uses_store: None) -> None:
    ...
    @pytest.mark.parametrize('do_reload_catalog', [False, True])
    def test_snapshots(self, do_reload_catalog: bool, uses_store: None) -> None:
    ...
    def test_table_time_travel(self, uses_store: None) -> None:
        pxt.create_dir('dir')
    ...
    def test_view_time_travel(self, uses_store: None) -> None:
        pxt.create_dir('dir')
        t = pxt.create_table('dir.test_tbl', {'c1': pxt.Int})
        assert t.get_metadata()['version'] == 0
        t.insert(c1=1)
    ...
    def test_time_travel_over_snapshot(self, uses_store: None) -> None:
        pxt.create_dir('dir')
        t = pxt.create_table('dir.test_tbl', {'c1': pxt.Int})
        assert t.get_metadata()['version'] == 0
    ...
    def test_column_defaults(self, uses_store: None) -> None:
        """
    ...
    def test_drop_base_column(self, uses_store: None) -> None:
        t = self.create_tbl()
        # create view with computed columns
        schema = {'v1': t.c3 * 2.0, 'v2': t.c6.f5}
    ...
    def test_rename_base_column(self, uses_store: None) -> None:
        t = self.create_tbl()
        schema = {'v1': t.c3 * 2.0, 'v2': t.c6.f5}
        v1 = pxt.create_view('test_view1', t, additional_columns=schema)
        v2 = pxt.create_view('test_view2', v1)
    ...
    def test_update_base_column(self, uses_store: None) -> None:
        t = self.create_tbl()
    ...
    def test_circular_view_def(self, uses_store: None) -> None:
