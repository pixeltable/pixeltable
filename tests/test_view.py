...
class TestView:
    ...
    def test_query_base_col(self, db_root: DatabaseRoot) -> None:
    ...
    def test_column_defaults(self, db_root: DatabaseRoot) -> None:
        """
    ...
    def test_circular_view_def(self, db_root: DatabaseRoot) -> None:
