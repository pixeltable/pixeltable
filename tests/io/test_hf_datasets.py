...
class TestHfDatasets:
    ...
    def test_import_hf_dataset(self, uses_store: None, tmp_path: pathlib.Path) -> None:
    ...
    def test_insert_hf_dataset(self, uses_store: None, tmp_path: pathlib.Path) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    def test_import_hf_dataset_invalid(self, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
    ...
    def test_import_images(self, streaming: bool, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    def test_import_arrays(self, streaming: bool, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    @pytest.mark.parametrize('streaming', [False, True])
    def test_import_audio_small(self, streaming: bool, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    def test_import_audio(self, streaming: bool, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    @pytest.mark.skipif(IN_CI, reason='Too much IO for CI')
    def test_import_list_of_dict(self, streaming: bool, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    @pytest.mark.parametrize('streaming', [False, True])
    @pytest.mark.skipif(IN_CI, reason='Too much IO for CI')
    def test_import_classlabel(self, streaming: bool, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    @pytest.mark.parametrize('streaming', [False, True])
    @pytest.mark.skipif(IN_CI, reason='Too much IO for CI')
    def test_import_sequence_of_float(self, streaming: bool, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    @pytest.mark.parametrize('streaming', [False, True])
    @pytest.mark.skipif(IN_CI, reason='Too much IO for CI')
    def test_import_sequence_of_dict(self, streaming: bool, uses_store: None) -> None:
        skip_test_if_not_installed('datasets')
        import datasets
    ...
    @pytest.mark.parametrize('streaming', [False, True])
    @pytest.mark.skipif(IN_CI, reason='Too much IO for CI')
    def test_import_nested_struct(self, streaming: bool, uses_store: None) -> None:
        """
    ...
    @pytest.mark.parametrize('streaming', [False, True])
    @pytest.mark.skipif(IN_CI, reason='Too much IO for CI')
    def test_import_arraynd(self, streaming: bool, uses_store: None) -> None:
