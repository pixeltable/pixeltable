...
def ls_image_table(init_ls: None, uses_store: None) -> pxt.Table:
    skip_test_if_not_installed('label_studio_sdk')
...
@pytest.fixture(scope='function')
def ls_video_table(init_ls: None, uses_store: None) -> pxt.Table:
    skip_test_if_not_installed('label_studio_sdk')
...
@pytest.fixture(scope='function')
def ls_audio_table(init_ls: None, uses_store: None) -> pxt.Table:
    skip_test_if_not_installed('label_studio_sdk')
