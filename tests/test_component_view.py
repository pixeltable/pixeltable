...
class TestComponentView:
    ...
    def test_add_column(self, uses_store: None) -> None:
        # create video table
    ...
    def test_update(self, uses_store: None) -> None:
        # create video table
        video_t = pxt.create_table('video_tbl', {'video': pxt.Video})
    ...
    def test_snapshot(self, has_column: bool, has_filter: bool, uses_store: None) -> None:
