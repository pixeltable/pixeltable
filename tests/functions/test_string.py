...
class TestString:
    ...
    def test_all(self, uses_store: None) -> None:
    ...
    def test_removeprefix(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_removesuffix(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_replace(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_slice_replace(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_partition(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_rpartition(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_wrap(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_slice(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_match(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_fullmatch(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_pad(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_normalize(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_repeat(self, uses_store: None) -> None:
    ...
    def test_contains(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_index(self, uses_store: None) -> None:
        t = pxt.create_table('test_tbl', {'s': pxt.String})
        validate_update_status(t.insert({'s': s} for s in self.TEST_STRS), expected_rows=len(self.TEST_STRS))
    ...
    def test_format(self, uses_store: None) -> None:
    ...
    def test_string_splitter(self, uses_store: None) -> None:
