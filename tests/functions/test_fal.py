...
class TestFal:
    ...
    def test_text_to_image_with_url(self, uses_store: None) -> None:
        skip_test_if_not_installed('fal_client')
        skip_test_if_no_client('fal')
        from pixeltable.functions.fal import run
    ...
    def test_fast_sdxl(self, uses_store: None) -> None:
        skip_test_if_not_installed('fal_client')
        skip_test_if_no_client('fal')
        from pixeltable.functions.fal import run
    ...
    def test_multiple_images(self, uses_store: None) -> None:
        skip_test_if_not_installed('fal_client')
        skip_test_if_no_client('fal')
        from pixeltable.functions.fal import run
