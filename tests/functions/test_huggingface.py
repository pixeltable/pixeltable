...
class TestHuggingface:
    def test_hf_function(self, uses_store: None) -> None:
    ...
    def test_sentence_transformer(self, uses_store: None, reload_tester: ReloadTester) -> None:
        skip_test_if_not_installed('sentence_transformers')
        from pixeltable.functions.huggingface import sentence_transformer
    ...
    def test_cross_encoder(self, uses_store: None) -> None:
        skip_test_if_not_installed('sentence_transformers')
    ...
    def test_clip(self, uses_store: None) -> None:
    ...
    def test_detr_for_object_detection(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_detr_for_segmentation(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
        import numpy as np
    ...
    def test_vit_for_image_classification(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_speech2text_for_conditional_generation(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_text_generation(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_text_classification(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_image_captioning(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_summarization(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_question_answering(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_translation(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_named_entity_recognition(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_automatic_speech_recognition(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    def test_text_to_speech(self, uses_store: None) -> None:
    ...
    @pytest.mark.skipif(IN_CI, reason='Large model; skipped in CI until we figure out the right CI strategy')
    @pytest.mark.expensive
    def test_text_to_image(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
    ...
    @pytest.mark.skipif(IN_CI, reason='Large model; skipped in CI until we figure out the right CI strategy')
    @pytest.mark.expensive
    def test_image_to_image(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
        skip_test_if_not_installed('diffusers')
    ...
    @pytest.mark.skipif(IN_CI, reason='Large model; skipped in CI until we figure out the right CI strategy')
    @pytest.mark.expensive
    def test_image_to_video(self, uses_store: None) -> None:
        skip_test_if_not_installed('transformers')
        skip_test_if_not_installed('diffusers')
