...
class TestSnapshot:
    ...
    def test_views_of_snapshots(self, anonymous: bool, uses_store: None) -> None:
    ...
    def test_snapshot_of_view_chain(self, uses_store: None) -> None:
        t = pxt.create_table('tbl', {'a': pxt.Int})
        rows = [{'a': 1}, {'a': 2}, {'a': 3}]
        validate_update_status(t.insert(rows), expected_rows=len(rows))
    ...
    def test_multiple_snapshot_paths(self, uses_store: None) -> None:
        t = create_test_tbl()
    ...
    def test_unstored_snapshot(self, uses_store: None, reload_tester: ReloadTester) -> None:
    ...
    def test_rename_column(self, uses_store: None) -> None:
        t = pxt.create_table('tbl', {'c1': pxt.Int, 'c2': pxt.Int})
