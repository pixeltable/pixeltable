...
class TestTypes:
    ...
    def test_from_python_type(self, init_env: None) -> None:
        ...
        for py_type, (pxt_type, string) in test_cases.items():
            ...
            assert ColumnType.from_python_type(None | py_type) == nullable_pxt_type
            ...
            assert ColumnType.from_python_type(None | py_type, nullable_default=True) == nullable_pxt_type
