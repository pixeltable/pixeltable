...
class TestDirs:
    def test_create(self, uses_store: None) -> None:
    ...
    def test_create_if_exists(self, uses_store: None) -> None:
    ...
    def test_drop(self, uses_store: None) -> None:
        dirs = ['dir1', 'dir1.sub1', 'dir1.sub1.subsub1']
        for name in dirs:
            pxt.create_dir(name)
        make_tbl('t1')
    ...
    def test_drop_force(self, uses_store: None) -> None:
        pxt.create_dir('dir1')
        pxt.create_dir('dir2')
    ...
    def test_create_with_parents(self, uses_store: None) -> None:
