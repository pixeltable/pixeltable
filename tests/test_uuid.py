...
class TestUUID:
    ...
    def test_uuid_function(self, uuid_fn: pxt.Function, uuid_version: int, uses_store: None) -> None:
    ...
    def test_uuid_type(self, uses_store: None, reload_tester: ReloadTester) -> None:
    ...
    def test_uuid_primary_key(self, uses_store: None, reload_tester: ReloadTester) -> None:
