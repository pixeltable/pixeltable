...
class TestExprs:
    ...
    def test_null_args(self, uses_store: None) -> None:
    ...
    def test_multi_json_mapper(self, uses_store: None, reload_tester: ReloadTester) -> None:
    ...
    def test_astype_str_to_img(self, uses_store: None) -> None:
    ...
    def test_astype_str_to_img_data_url(self, uses_store: None) -> None:
    ...
    def test_ext_imgs(self, uses_store: None) -> None:
    ...
    def test_window_fns(self, uses_store: None, test_tbl: pxt.Table) -> None:
        t = test_tbl
    ...
    def test_agg(self, uses_store: None) -> None:
    ...
    def test_repr(self, uses_store: None) -> None:
    ...
    def test_string_operations(self, test_tbl: pxt.Table, uses_store: None, reload_tester: ReloadTester) -> None:
        # create table with two columns
