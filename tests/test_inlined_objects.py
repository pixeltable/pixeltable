...
class TestInlinedObjects:
    def test_null_arrays(self, uses_store: None) -> None:
    ...
    def test_insert_arrays(self, uses_store: None) -> None:
    ...
    def test_insert_binary(self, uses_store: None) -> None:
    ...
    def test_insert_inlined_objects(self, uses_store: None) -> None:
    ...
    def test_nonstandard_json_construction(self, uses_store: None) -> None:
        reload_tester = ReloadTester()
    ...
    def test_samples(self, uses_store: None) -> None:
        reload_tester = ReloadTester()
