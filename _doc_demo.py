...
t = pxt.create_table(f'{DIR}/papers', {'title': pxt.String, 'doc': pxt.Document, 'category': pxt.String})

rows = [
    {'title': 'Attention Is All You Need', 'doc': 'https://arxiv.org/pdf/2312.00752', 'category': 'ML'},
    {
        'title': 'US Constitution',
        'doc': 'https://www.archives.gov/files/founding-docs/constitution-page1-high-res.pdf',
        'category': 'Legal',
    },
    {'title': 'Python PEP 8', 'doc': 'https://peps.python.org/pep-0008/', 'category': 'Programming'},
]
